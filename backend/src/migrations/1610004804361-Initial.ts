...
export class Initial1610004804361 implements MigrationInterface {
    name = 'Initial1610004804361'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "like" ("voted" integer NOT NULL DEFAULT '0', "userId" integer NOT NULL, "postId" integer NOT NULL, CONSTRAINT "PK_78a9f4a1b09b6d2bf7ed85f252f" PRIMARY KEY ("userId", "postId"))`);
