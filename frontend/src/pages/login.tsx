          ...
          >
            {({ isSubmitting }) => (
              <Form>
                ...
                <button
                  type="submit"
                  className="block flex justify-center w-full px-4 py-3 mt-6 font-semibold text-white transition duration-500 ease-in-out transform rounded-lg bg-gradient-to-r from-blue-700 hover:from-blue-600 to-blue-600 hover:to-blue-700 focus:shadow-outline focus:outline-none"
                >
                  {isSubmitting ? (
                    <svg
                      width="20"
