              ...
              <div>
                {!fetching && data?.me ? (
                  <div className="flex flex-col">
                    ...
                    <NextLink href="/create-post">
                      <div className={mobileInactive}>Upload</div>
                    </NextLink>
                    <NextLink href="/#">
                      <div className={mobileInactive}>Profile</div>
                    </NextLink>
                    <NextLink href="/#">
                      <div className={mobileInactive}>Notifications</div>
                    </NextLink>
                    <NextLink href="/#">
                      <div className={mobileInactive}>Settings</div>
                    </NextLink>
                    <div
                      onClick={async () => {
                        await logout();
                  ...
                  <div className="flex flex-col">
                    <NextLink href="/login">
                      <div className={mobileInactive}>Login</div>
                    </NextLink>
                    <NextLink href="/register">
                      <div className={mobileInactive}>Sign Up</div>
                    </NextLink>
                  </div>
                )}
              </div>
